...
export function Container({ children }: { children: ReactNode }) {
  return (
    <div className="relative ">
      <section className="bg-gradient-to-r from-blue-300 to-green-500 bg-[url('/background/stars-bg-gray.png')] bg-cover px-6 md:flex md:gap-28 lg:gap-28 md:py-8 lg:px-40">
        <Image
